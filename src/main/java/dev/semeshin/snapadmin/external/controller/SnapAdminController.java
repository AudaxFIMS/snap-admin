...
import dev.semeshin.snapadmin.external.dbmapping.DbObject;
...
import dev.semeshin.snapadmin.external.dbmapping.query.DbQueryResult;
import dev.semeshin.snapadmin.external.dto.CompareOperator;
import dev.semeshin.snapadmin.external.dto.FacetedSearchRequest;
...
import dev.semeshin.snapadmin.external.dto.QueryFilter;
import dev.semeshin.snapadmin.external.dto.ValidationErrorsContainer;
import dev.semeshin.snapadmin.external.exceptions.InvalidPageException;
...
import dev.semeshin.snapadmin.external.misc.Utils;
...
import dev.semeshin.snapadmin.internal.service.ConsoleQueryService;
import dev.semeshin.snapadmin.internal.service.UserActionService;
import dev.semeshin.snapadmin.internal.service.UserSettingsService;
...
public class SnapAdminController {
	...
	public String list(Model model, @PathVariable String className,
		...
		try {
			...
			model.addAttribute("title", "Entities | " + schema.getSimpleClassName() + " | Index");
	...
	public String show(Model model, @PathVariable String className, @PathVariable String id) {
		...
		model.addAttribute("title", "Entities | " + schema.getSimpleClassName() + " | " + object.getDisplayName());
	...
	public String create(Model model, @PathVariable String className, RedirectAttributes attr) {
		...
		model.addAttribute("schema", schema);
		model.addAttribute("title", "Entities | " + schema.getSimpleClassName() + " | Create");
		model.addAttribute("activePage", "entities");
	...
	public String edit(Model model, @PathVariable String className, @PathVariable String id, RedirectAttributes attr) {
		...
		model.addAttribute("title", "Entities | " + schema.getSimpleClassName() + " | Edit | " + object.getDisplayName());
		model.addAttribute("className", className);
		model.addAttribute("object", object);
		model.addAttribute("schema", schema);
		model.addAttribute("activePage", "entities");
	...
	public String delete(@PathVariable String className, @PathVariable String id, RedirectAttributes attr,
		...
		attr.addFlashAttribute("message", "Deleted " + schema.getSimpleClassName() + " with "
