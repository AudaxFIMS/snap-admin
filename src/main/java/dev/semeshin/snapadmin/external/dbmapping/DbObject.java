...
import dev.semeshin.snapadmin.external.annotations.DisplayName;
import dev.semeshin.snapadmin.external.dbmapping.fields.BooleanFieldType;
...
public class DbObject {
	...
	protected List<Method> getAllDeclaredMethods(Class<?> type) {
